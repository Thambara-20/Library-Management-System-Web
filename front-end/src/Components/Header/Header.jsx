            ...
            try {
              if (user.name) {
                ...
                if (user.isAdmin) {
                  ...
                  setAdminLoggedIn(false); // Ensure isAdminLoggedIn is false when not admin
                }
              } else {
                setUserLogIn(false);
                setAdminLoggedIn(false); // Ensure isAdminLoggedIn is false when not logged in
              }
            } catch { 
              setUserLogIn(false);
              setAdminLoggedIn(false); // Ensure isAdminLoggedIn is false on error
            }
          }, []);
